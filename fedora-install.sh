...
# packages
sudo dnf install g++ feh neofetch nodejs clang-tools-extra htop curl neovim mingw64-gcc-c++ fontawesome-fonts-all flatpak xcompmgr flameshot blueman pasystray sqlite kitty keepassxc python3-pip xclip -y -y -y
